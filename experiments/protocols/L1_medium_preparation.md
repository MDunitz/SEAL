...
# L1 Medium Preparation (Guillard & Hargraves 1993)
### Version: V1
...
Per 1 L, begin with 950 mL ASW. Add L1 nutrient stocks, trace element solution, and vitamin solution. For agar plates, add 15 g/L agar before autoclaving.
...
4. Add remaining trace metals from individual stocks:
...
1. Start with 950 mL ASW in a 1 L bottle or flask.
2. Add 1 mL each of NaNO3, NaH2PO4, and Na2SiO3 stocks.
3. Add 1 mL trace element solution.
4. Add 0.5 mL vitamin solution.
5. For agar plates: add 15 g/L agar.
6. Bring to 1 L with ASW.
7. Autoclave (121 C, 15 min).
8. Final pH 8.0-8.2.

## Note on Phosphate and La Precipitation

L1 contains 36.2 uM phosphate, which will precipitate some La3+ as insoluble LaPO4. At 10 uM La and pH 8, expect partial loss. A white haze in La=10uM plates is normal. The 10 pM and 10 nM conditions are below the precipitation threshold and remain fully soluble.

## Storage

- Liquid L1: 4 C, use within 2 weeks
- L1 agar (autoclaved, solidified): room temperature, use within 1 month
- Trace element solution: 4 C, stable for months
- Vitamin solution: -20 C in foil-wrapped aliquots, prepare fresh if >3 months old
